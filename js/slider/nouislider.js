...
// Value calculation
    ...
    * @returns {number}
    */
   function fromPercentage(ranges, value)
   {
      return (value * 100) / ( ranges[1] - ranges[0] );
   }
...
// Entry parsing
   ...
   function handleStepPoint(i, n, that)
   {
      ...
      that.xSteps[i] = fromPercentage([that.xVal[i], that.xVal[i + 1]], n) /
...
// Interface
   ...
   function testOptions(options)
   {
      ...
      // To prove a fix for Issue #537, [freeze options here.]
