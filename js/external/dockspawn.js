...
dockspawn.PanelContainer.prototype._initialize = function()
{
    ...
    // this.elementButtonClose.innerHTML = '<i class="fa faclose"></i>';
    this.elementButtonClose.innerHTML = '&times;';
