function Timetable(){this.scope={hourStart:9,hourEnd:17};this.locations=[];this.events=[]}Timetable.Renderer=function(f){if(!(f instanceof Timetable))throw Error("Initialize renderer using a Timetable");this.timetable=f};
