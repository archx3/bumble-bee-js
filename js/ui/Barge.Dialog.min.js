...
k.classList.contains("primary")||k.classList.add("primary"),h.classList.contains("primary")&&h.classList.remove("primary")});return l}function v(a,b,c,d){t(a);var e=document.createElement("div");e.id="msgBx";new Barge.Drag.Movable(e);e.appendChild(q(b));e.appendChild(r(a,c,d));return e}function w(a,b,c,d,e){t(a);var f=document.createElement("div");f.id="msgBx";new Barge.Drag.Movable(f);f.appendChild(q(b));f.appendChild(u(c,"prompt"));f.appendChild(r(a,d,e));return f}function x(a,b,c,d,e,f,g,l){t(a);
var h=document.createElement("div");h.id="msgBx";new Barge.Drag.Movable(h);h.appendChild(q(b));h.appendChild(u(c,!1,l,a));h.appendChild(r(a,d,e,f,g));return h}function y(a,b,c,d,e,f,g){t(a);var l=document.createElement("div");l.id="msgBx";new Barge.Drag.Movable(l);l.appendChild(q(b));l.appendChild(u(d,!1,g));l.appendChild(r(a,e,!1,f,!1,!0,c));return l}function z(a,b,c,d,e){t(a);var f=document.createElement("div");f.id="msgBx";new Barge.Drag.Movable(f);f.appendChild(q(b));f.appendChild(r(a,d,!1,e,
!1,!0,c));return f}function t(a){var b=document.createElement("style");b.id="dialogStyle";if("light"==a)return b.innerHTML=A,document.head.appendChild(b),!1;b.innerHTML=B;document.head.appendChild(b)}function n(a,b,c,d){if(c&&void 0!==c&&"string"===typeof d&&""!==d)return window.location.assign(d),p(a),!1;if(void 0!==b&&"string"===typeof b)return window[b](),p(a),!1;p(a)}Barge.Dialog={lightRedirectConfirm:function(a,b,c,d,e,f){g.gebi("msgBx")||(document.body.appendChild(m()),document.body.appendChild(y("light",
a,b,c,d,e,f)))},darkRedirectConfirm:function(a,b,c,d,e,f){g.gebi("msgBx")||(document.body.appendChild(m()),document.body.appendChild(y("dark",a,b,c,d,e,f)))},lightRedirectAlert:function(a,b,c,d){g.gebi("msgBx")||(document.body.appendChild(m()),document.body.appendChild(z("light",a,b,c,d)))},darkRedirectAlert:function(a,b,c,d){g.gebi("msgBx")||(document.body.appendChild(m()),document.body.appendChild(z("dark",a,b,c,d)))},lightAlert:function(a,b,c){g.gebi("msgBx")||(document.body.appendChild(m()),document.body.appendChild(v("light",
