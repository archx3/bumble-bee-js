...
(function (Bu, Bs, Bo, Bd)
{
   ...
   Barge.Dom.Toolbox = function (options, dragOptions)
   {
      ...
      Bu.assert(Bu.defined(window) && Bu.defined(document),
                'Barge.Dom.Toolbox a window object as host');
      ...
      Bu.assert(Bu.defined(options.toolBoxID) || Bu.defined(options.toolBoxListNodeID) ||
                ...
                'Barge.Dom.Toolbox expects non-null params: toolBoxNodeID,' +
      ...
      this.options = {
          ...
          * issue #66
          * icon swapping must be well implemented to avoid event listener removal
          */
      ...
      /**
       * caching the tool box I's fields len to avoid re-querying in for loops
       * @type {Number} NIU
       */
   ...
   Barge.Dom.Toolbox.prototype._openWin = function (windowEl)
   {
      ...
      {
         Bd.setDisplayState(windowEl, "block");
      }
   };
   ...
   Barge.Dom.Toolbox.prototype.addClickEvent = function ()
   {
      ...
      //using click now (mousedown is messing up)
      this.Be.bindOnAll(self.toolBoxItems, 'click', function (e)
      {
         ...
         if (hasFlyOut)
         {
            ...
            if (self._getDisplayState(flyOut) === 1)
            {
               ...
               window.toolBoxFlyOutIsOpen = false;
            ...
            else
            {
                   ...
                   window.toolBoxFlyOutIsOpen = true;
 ...
 *          to tell the outside world the state of {@link Barge.Dom.Toolbox.aFlyOutIsOpen}
 *
 */