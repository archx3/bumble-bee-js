...
(function (global, factory)
{
   if (typeof define === 'function' && define.amd)
   {
      ...
      define([], function ()
      {
         return (global['Barge.MenuBar'] = factory(global));
      });
   }
   ...
   {
      global['Barge.MenuBar'] = factory(global);
   }
})(typeof window !== undefined ? window : this, function factory(window)
{
   ...
   /**
    *
    * @param options {{menuItemsClassName : String,
         submenuDirection   : String<left|right>,
         recurse            : Boolean,
         menuItems : {id : {name : String}},
         }}
    * @constructor
    */
   ...
   MenuBar.prototype._openWin = function (windowEl)
   {
    ...
    * @private
    */
   MenuBar.prototype._getSlope = function (a, b)
   {
   ...
   MenuBar.prototype._createItems = function (items, isSub)
   {
      let self = this,
      ...
      Bo.forEach(items, function (item)
      {
         ...
         { // An array will return 'object'
            ...
            html += self._createItems(data[item].sub, true);
         }
         else
         {
    ...
    * @private
    */
   MenuBar.prototype._disabled = function (item)
   {
    ...
    * @private
    */
   MenuBar.prototype._noHover = function (item)
   {
    ...
    * @private
    */
   MenuBar.prototype._getDisplayState = function (el)
   {
    ...
    * @private
    */
   MenuBar.prototype._hasSubMenuOpen = function (menuItem)
   {
    ...
    * @private
    */
   MenuBar.prototype._closeAllSubMenus = function (menuItems, rootChild, innerRoot)
   {
      var self = this;
      if (menuItems)
      {
   ...
   MenuBar.prototype._closeOpenSubMenus = function (menuItem)
   {
      var self = this;
   ...
   MenuBar.prototype.addClickEvent = function ()
   {
      var self = this;
    ...
    * @private
    */
   MenuBar.prototype._collectAllMenuItems = function (items)
   {
      const self = this;
   ...
   MenuBar.prototype.getAllMenuItems = function ()
   {
      return this.allItems;
   };

   MenuBar.prototype.addMouseOverEvent = function ()
   {
      var self = this;
   ...
   MenuBar.prototype.addMouseOutEvent = function ()
   {
      var self = this;
   ...
   MenuBar.prototype.addCloseOutEvent = function ()
   {
      var self = this;
   ...
   MenuBar.prototype.create = function ()
   {
      ...
      if(Bu.defined(self.options.menuItems)){
         self._createItems(self.options.menuItems)
      }

      //FIXME define the logic of collecting items differently;
      // based on whether there exists a menu list object or not
