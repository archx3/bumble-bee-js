var Bee=Bee||{};
(function(q){Bee.String={RSPACE:/\s+/g,rand:function(a){a=void 0===a?5:a;if(!q.isNumber(a)||1>a)throw Error("rand expects an integer greater than 0");for(var b="",c=0;c<a;c++)b+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".charAt(Math.floor(62*Math.random()));return b},toSentenceCase:function(a){a=a.toString();a=a.toLowerCase();return a[0].toUpperCase()+a.substring(1,a.length)},capitalise:function(a){a=a.toString();a=a.toLowerCase();var b=a.split(" ");a="";for(var c=0;c<b.length;c++){var d=
