...
goog.userAgentTestUtil.reinitializeUserAgent = function() {
  ...
  goog.userAgent.MOBILE = goog.userAgent._isMobile();
  goog.userAgent.SAFARI = goog.userAgent.WEBKIT;

  // Platform in goog.userAgent.
  goog.userAgent.PLATFORM = goog.userAgent._determinePlatform();

  goog.userAgent.MAC = goog.labs.userAgent.platform.isMacintosh();
  goog.userAgent.WINDOWS = goog.labs.userAgent.platform.isWindows();
  goog.userAgent.LINUX = goog.userAgent._isLegacyLinux();
  goog.userAgent.X11 = goog.userAgent._isX11();
  ...
  goog.userAgent.VERSION = goog.userAgent._determineVersion();

  // Platform in goog.userAgent.platform.
  goog.userAgent.platform.VERSION = goog.userAgent.platform._determineVersion();
  ...
  goog.userAgent.product.VERSION = goog.userAgent.product._determineVersion();
