...
(function () {
   ...
   Timetable.prototype = {
      ...
      addLocations : function (newLocations) {
         ...
         if (Bu.isArray(newLocations))
         {
            Ba.forEach(newLocations, function (loc)
            {
         ...
         else if (Bu.isObject(newLocations))
         {
            Bo.forEach(newLocations, function (loc)
            {
               if (!locationExistsIn(loc, existingLocations))
               {
                  existingLocations.push(loc);
         ...
         {
            throw new Error('Wrong Locations format');
         }
