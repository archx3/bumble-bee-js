...
(function(){function f(a){return a===parseInt(a,10)&&0<=a&&24>a}function q(a,b){return b>=a?b-a:24+b-a}function n(a){for(;a.firstChild;)a.removeChild(a.firstChild)}Timetable.prototype={setScope:function(a,b){if(f(a)&&f(b))this.scope.hourStart=a,this.scope.hourEnd=b;else throw new RangeError("Timetable scope should consist of (start, end) in whole hours from 0 to 23");return this},addLocations:function(a){var b=this.locations;if(a instanceof Array)a.forEach(function(a){if(-1===b.indexOf(a))b.push(a);
else throw Error("Location already exists");});else throw Error("Tried to add locations in wrong format");return this},addEvent:function(a,b,m,d,r){if(-1===this.locations.indexOf(b))throw Error("Unknown location");if(!(m instanceof Date&&d instanceof Date&&m<d))throw Error("Invalid time range: "+JSON.stringify([m,d]));var g="[object Object]"===Object.prototype.toString.call(r);this.events.push({name:a,location:b,startDate:m,endDate:d,options:g?r:void 0});return this}};Timetable.Renderer.prototype=
{draw:function(a){var b=this.timetable,m=q(b.scope.hourStart,b.scope.hourEnd);a=document.querySelector(a);if(null===a)throw Error("Timetable container not found");n(a);(function(a){a=a.appendChild(document.createElement("aside")).appendChild(document.createElement("ul"));for(var d=0;d<b.locations.length;d++){var g=a.appendChild(document.createElement("li")).appendChild(document.createElement("span"));g.className="row-heading";g.textContent=b.locations[d]}})(a);(function(a){a=a.appendChild(document.createElement("section")).appendChild(document.createElement("time"));
