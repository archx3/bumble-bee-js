...
(typeof window !== 'undefined' ? window : this, function (win)
{
   ...
   (function (H)
   {
       ...
       * it attempts to set expand properties on the SVG element, which is not allowed.
       *
      ...
      H.dateFormat = function (format, timestamp, capitalize)
      {
         ...
         var D             = H.Date,
             ...
             replacements  = H.extend({
                                         ...
                                         // Day
                                         'a' : shortWeekdays ? shortWeekdays[day] : langWeekdays[day].substr(0, 3), // Short weekday,
                                                                                                                    // like 'Mon'
      ...
      SVGRenderer.prototype = {
         ...
         symbols : {
            ...
            'arc'           : function (x, y, w, h, options)
            {
               var start       = options.start,
                   ...
                   end         = options.end - 0.001, // to prevent cos and sin of start and end from becoming equal on 360 arcs
                                                      // (related: #1561)
         ...
         label : function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className)
         {
            ...
            wrapper.onAdd = function ()
            {
               text.add(wrapper);
               wrapper.attr({
                               text : (str || str === 0) ? str : '', // alignment is available now // #3295: 0 not rendered if given
                                                                     // as a value
                               x    : x,
                               y    : y
                            });
   ...
   (function (H)
   {
      ...
      H.Axis.prototype = {
         ...
         nameToX : function (point)
         {
            ...
            if (nameX === -1)
            { // The name is not found in currenct categories
   ...
   (function (H)
   {
      ...
      H.Tooltip.prototype = {
         ...
         defaultFormatter : function (tooltip)
         {
            ...
            // footer
            s.push(tooltip.tooltipFooterHeaderFormatter(items[0], true)); //#3397: abstraction to enable formatting of footer and
                                                                          // header
            ...
            else
            {
               ...
               each(series, function (s)
               {
                  ...
                  { // #3821
                     ...
                     { // Point.series becomes null when reset and before redraw (#5197)
      ...
      Legend.prototype = {
         ...
         adjustMargins : function (margin, spacing)
         {
            var chart     = this.chart,
                ...
                alignment = options.align.charAt(0) + options.verticalAlign.charAt(0) + options.layout.charAt(0); // #4189 - use
                                                                                                                  // charAt(x)
                                                                                                                  // notation instead
                                                                                                                  // of [x] for IE7
   ...
   (function (H)
   {
      ...
      H.Series = H.seriesType('line', null, { // base series options
                                 ...
                                 cropThreshold    : 300, // draw points outside the plot area when the number of points is less than
                                                         // this
                                 pointRange       : 0,
                                 //pointStart: 0,
                                 //pointInterval: 1,
                              ...
                              // Prototype properties
                              {
                                 ...
                                 getColor : function ()
                                 {
                                    ...
                                    {
                                       this.options.color = null; // #4359, selected slice got series.color even when colorByPoint was
                                                                  // set.
                                    }
                                    else
                                    {
                                 ...
                                 generatePoints : function ()
                                 {
                                    ...
                                    // Hide cropped-away points - this only runs when the number of points is above cropThreshold, or
                                    // when swithching view from non-grouped data to grouped data (#637)
                                    ...
                                    each(props, function (prop, i)
                                    {
                                       ...
                                       { // #1487
                                          ...
                                          attribs = {
                                             ...
                                             'fill'         : (series.fillGraph && series.color) || 'none' // Polygon series use
                                                                                                           // filled graph
                                          };
                                          ...
                                          graph = series[graphKey]
                                             .attr(attribs)
                                             .shadow((i < 2) && options.shadow); // add shadow to normal series (0) or to first zone
                                                                                 // (1) #3932
                                 ...
                                 render : function ()
                                 {
                                    ...
                                    // Initial clipping, must be defined after inverting groups for VML. Applies to columns etc.
                                    // (#3839).
                                    ...
                                    // (See #322) series.isDirty = series.isDirtyData = false; // means data is in accordance with
                                    // what you see
                                 ...
                                 redraw : function ()
                                 {
                                    var series   = this,
                                        chart    = series.chart,
                                        wasDirty = series.isDirty || series.isDirtyData, // cache it here as it is set to false in
                                 ...
                                 buildKDTree : function ()
                                 {
                                    ...
                                    // Start the recursive build process with a clone of the points array and null points filtered out
                                    // (#3873)
                                    function startRecursive()
                                    {
                                       series.kdTree = _kdtree(
                                          series.getValidPoints(
                                             null, !series.directTouch // For line-type series restrict to plot area, but column-type
                                                                       // series not (#3916, #4511)
                                          ),
                                          dimensions,
                                          dimensions
                                       );
                                 ...
                                 searchKDTree : function (point, compareX)
                                 {
                                    ...
                                    function _search(search, tree, depth, dimensions)
                                    {
                                       ...
                                       if (tree[sideB])
                                       {
                                          // compare distance to current best to splitting point to decide wether to check side B or
                                          // not
   ...
   (function (H)
   {
      ...
      StackItem.prototype = {
         ...
         render : function (group)
         {
            ...
            {
               this.label =
                  this.axis.chart.renderer.text(str, null, null, options.useHTML) // dummy positions, actual position updated with setOffset method in
                                                                // columnseries
         ...
         setOffset : function (xOffset, xWidth)
         {
            var stackItem  = this,
                ...
                y          = axis.translate(axis.usePercentage ? 100 : this.total, 0, 0, 0, 1), // stack value translated mapped to
                                                                                                // chart coordinates
      ...
      seriesType('area', 'line', {
         ...
         // fillColor: null
                    ...
                    getGraphPath : function (points)
                    {
                       ...
                       graphPath = getGraphPath.call(this, graphPoints, false, connectNulls); // TODO: don't set leftCliff and
                                                                                              // rightCliff when connectNulls?
   ...
   (function (H)
   {
      ...
      seriesType('column', 'line', {
         ...
         pointRange         : null, // null means auto, meaning 1 in a categorized axis and least distance between points if not
                                    // categories
         states             : {
            hover : {
               halo : false,
         ...
         // Prototype members
                    ...
                    cropShoulder  : 0,
                    directTouch   : true, // When tooltip is not shared, this series (and derivatives) requires direct touch/hover.
                                          // KD-tree does not apply.
                    ...
                    translate : function ()
                    {
                       ...
                       each(series.points, function (point)
                       {
                          var yBottom      = pick(point.yBottom, translatedThreshold),
                              ...
                              plotY        = Math.min(Math.max(-safeDistance, point.plotY), yAxis.len + safeDistance), // Don't draw
                                                                                                                       // too far
                                                                                                                       // outside plot
                                                                                                                       // area (#1303,
                                                                                                                       // #2241,
                    ...
                    pointAttribs : function (point, state)
                    {
                       var options           = this.options,
                           ...
                           stroke            = options[strokeOption] || this.color || fill, // set to fill when borderColor = null on
                                                                                            // pies
                           dashstyle         = options.dashStyle,
                           zone,
                           brightness;
                       ...
                       {
                          zone = point.getZone();
                          fill = (zone && zone.color) || point.options.color || this.color; // When zones are present, don't use
                                                                                            // point.color (#4267)
                       }
      ...
      if (seriesTypes.column)
      {
         ...
         seriesTypes.column.prototype.alignDataLabel = function (point, dataLabel, options, alignTo, isNew)
         {
            var inverted = this.chart.inverted,
                ...
                below    = pick(point.below, point.plotY > pick(this.translatedThreshold, series.yAxis.len)), // point.below is used
                                                                                                              // in range series
                                        ...
                                        function collectAndHide()
                                        {
                                           ...
                                           each(chart.series, function (series)
                                           {
                                              var dlOptions   = series.options.dataLabels,
                                                  collections = series.dataLabelCollections || ['dataLabel']; // Range series have two
                                                                                                              // collections
