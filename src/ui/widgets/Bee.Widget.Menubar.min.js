...
(function(c,h,f){Bee.Widget=Bee.Widget||{};Bee.Widget.MenuBar=function(a){this.options={menuItemsClassName:"menuItem",submenuDirection:"right",recurse:!1,menuItems:null};a&&(this.options=c.extend(this.options,a));this.Be=new Bee.Event.EventManager;this.menuItems=c.nodeListToArray(document.getElementsByClassName(this.options.menuItemsClassName));this.allItems=[];this.itemsWithSubMenu=[];this.len=this.menuItems.length;this.i=0;this.gSubSubMenuItems=this.gsubMenuItems=null;this.aSubMenuIsOpen=!1;this.openSubSubMenu=
this.openSubMenu=null;this.openSubMenus=[];this.aSubMenuGrandChildMenuIsOpen=this.aSubMenuChildMenuIsOpen=!1;this.lowerRight=this.lowerLeft=this.upperRight=this.upperLeft=null;this.activeRow=c.defined(this.openSubMenu)?this.openSubMenu:null;this.mouseLocs=[];this.loc=this.mouseLocs[this.mouseLocs.length-1];this.prevLoc=this.mouseLocs[0];this.MOUSE_LOCS_TRACKED=3;this.menuBarActivated=!1;this.aSubMenuIsOpen=this.menuItems.some(this._hasSubMenuOpen)};Bee.Widget.MenuBar.prototype._openWin=function(a){0===
this._getDisplayState(a)&&c.setDisplayState(a,"block")};Bee.Widget.MenuBar.prototype._getSlope=function(a,b){return((b.y?b.y:b.top?b.top:0)-(a.y?a.y:a.top?a.top:0))/((b.x?b.x:b.right?b.right:0)-(a.x?a.x:a.right?a.right:0))};Bee.Widget.MenuBar.prototype._disabled=function(a){return a.classList.contains("disabled")};Bee.Widget.MenuBar.prototype._noHover=function(a){return a.classList.contains("noHov")};Bee.Widget.MenuBar.prototype._getDisplayState=function(a){return"none"===a.style.display||""===a.style.display?
0:1};Bee.Widget.MenuBar.prototype._hasSubMenuOpen=function(a){return(a=a.children[1])&&"UL"===a.tagName&&"block"===a.style.display};Bee.Widget.MenuBar.prototype._closeAllSubMenus=function(a,b,d){if(a)for(var e=0,f=a.length;e<f;e++){var g=a[e].children[1],k=a[e].children[1]&&"UL"===g.tagName;g&&1===this._getDisplayState(g)&&(k&&c.closeWin(g),b&&c.css(a[e].children[0],{backgroundColor:""}));d&&c.css(a[e],{backgroundColor:""})}};Bee.Widget.MenuBar.prototype._closeOpenSubMenus=function(a){c.defined(this.openSubMenu)&&
(c.css(this.openSubMenu,{display:"none"}),c.css(a.children[0],{backgroundColor:""}));c.defined(this.openSubSubMenu)&&c.css(this.openSubSubMenu,{display:"none"})};Bee.Widget.MenuBar.prototype.addClickEvent=function(){var a=this;this.Be.bindOnAll(a.menuItems,"click",function(b){var d=this.children[1],e=this.children[0];b=b.target;this.children[1]&&"UL"===d.tagName?1===a._getDisplayState(d)?(c.closeWin(d),c.css(e,{backgroundColor:""}),a.aSubMenuIsOpen=!1,a._closeAllSubMenus(a.allItems,!1,!0),a.aSubMenuChildMenuIsOpen=
...
a.aSubMenuIsOpen=!1})};Bee.Widget.MenuBar.prototype._collectAllMenuItems=function(a){var b=this;h.forEach(a,function(a,c){(c=a.children[1])&&"UL"===c.tagName?(0>b.menuItems.indexOf(a)&&!a.classList.contains("hDivider")&&b.allItems.push(a),b._collectAllMenuItems(c.children)):!a.classList.contains("hDivider")&&0>b.menuItems.indexOf(a)&&b.allItems.push(a)})};Bee.Widget.MenuBar.prototype.getAllMenuItems=function(){return this.allItems};Bee.Widget.MenuBar.prototype.addMouseOverEvent=function(){var a=this,
