...
keepState:!0,keepSortHeadsState:!0,tabbedViewID:null,canAddTab:!1,addButtonCallback:null,canRemoveTab:!1,maxNumberOfTabs:9,genericTabName:"Untitled Tab",autoCreate:!0,scrollablePanes:!1};c&&(this.options=g.extend(this.options,c));!0===this.options.autoCreate&&this.create()}Bee.Widget=Bee.Widget||{};var g=Bee.Utils,l=Bee.String,h=Bee.Widget,m=Bee.Object,n=new Bee.Event.EventManager;e.prototype.create=function(){var a=h.createEl("div",{className:"tabbedView"},this.options.style);a.appendChild(this._renderTabHeads(this.tabHeadNames));
