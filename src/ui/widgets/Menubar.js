...
(function (Bu, Ba, Bd)
{
   ...
   Bee.Widget.MenuBar = function (options)
   {
      /**
       *
       * @type {Object}
   ...
   Bee.Widget.MenuBar.prototype._openWin = function (windowEl)
   {
    ...
    * @private
    */
   Bee.Widget.MenuBar.prototype._getSlope = function (a, b)
   {
    ...
    * @private
    */
   Bee.Widget.MenuBar.prototype._disabled = function (item)
   {
    ...
    * @private
    */
   Bee.Widget.MenuBar.prototype._noHover = function (item)
   {
    ...
    * @private
    */
   Bee.Widget.MenuBar.prototype._getDisplayState = function (el)
   {
    ...
    * @private
    */
   Bee.Widget.MenuBar.prototype._hasSubMenuOpen = function (menuItem)
   {
    ...
    * @private
    */
   Bee.Widget.MenuBar.prototype._closeAllSubMenus = function (menuItems, rootChild, innerRoot)
   {
      var self = this;
      if (menuItems)
      {
   ...
   Bee.Widget.MenuBar.prototype._closeOpenSubMenus = function (menuItem)
   {
      var self = this;
   ...
   Bee.Widget.MenuBar.prototype.addClickEvent = function ()
   {
      var self = this;
    ...
    * @private
    */
   Bee.Widget.MenuBar.prototype._collectAllMenuItems = function (items)
   {
      const self = this;
   ...
   Bee.Widget.MenuBar.prototype.getAllMenuItems = function ()
   {
      return this.allItems;
   };

   Bee.Widget.MenuBar.prototype.addMouseOverEvent = function ()
   {
      var self = this;
   ...
   Bee.Widget.MenuBar.prototype.addMouseOutEvent = function ()
   {
      var self = this;
   ...
   Bee.Widget.MenuBar.prototype.addCloseOutEvent = function ()
   {
      var self = this;
   ...
   Bee.Widget.MenuBar.prototype.create = function ()
   {
      let self = this;
   ...
   return MenuBar = Bee.Widget.MenuBar;

})(Bee.Utils, Bee.Array, Bee.Widget);

var menubar = new Bee.Widget.MenuBar();
menubar.create();
