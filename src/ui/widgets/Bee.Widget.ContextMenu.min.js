...
"light")?Bee.Dialog.darkConfirm("Sorry","Pasting from System Clipboard is not allowed","OK",!1,!1,!1,"failure"):Bee.Dialog.lightConfirm("Sorry","Pasting from System Clipboard is not allowed","OK",!1,!1,!1,"failure")):"cutToCB"==this.id?b&&(f=Bee.CopyCat.getSelectedInputText(a),Bee.CopyCat.copySelectionText(),d.deleteSelectedText(a)):"selAllToCB"==this.id?b&&(a.select(),Bee.CopyCat.selectALl()):"clearText"==this.id&&b&&Bee.Input.clear(a)},!1)})(Bee.Utils,Bee.Array,Bee.String,Bee.Widget);
