...
a.aGutterSize))},destroy:function(){for(var a=0;a<k.length;a++)k[a].parent.removeChild(k[a].gutter),k[a].a.style[f]="",k[a].b.style[f]=""}}};if("undefined"!==typeof u){if("undefined"!==typeof module&&module.exports)var u=module.exports=Split;u.Bd.SplitPanes=r.SplitPanes}else Bee.Widget.SplitPanes=r.SplitPanes}).call(window)})(Bee.Utils,Bee.Widget);
