...
!window.document)return function(){throw Error("DragSorter.js requires a window with a document");};var d,B,h,r,l,K,u,Q,R,S,M,T,v,p,F,U,A={},C,x,N,W=/\s+/g,E="DragSorter"+(new Date).getTime(),G=window,k=G.document,ca=!!("draggable"in k.createElement("div")),ba=function(a){if(navigator.userAgent.match(/Trident.*rv[ :]?11\./))return!1;a=k.createElement("x");a.style.cssText="pointer-events:auto";return"auto"===a.style.pointerEvents}(),P=!1,H=Math.abs,fa=Math.min,J=[],f=new Bee.Event.EventManager,ha=
