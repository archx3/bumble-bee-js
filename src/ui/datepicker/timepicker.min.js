...
function(){var a=this.time.getMinutes();return 10>a?"0"+a:a};b.prototype.getMeridian=function(){return this.settings.meridian?12<=this.time.getHours()?"pm":"am":""};return Barge.TimePicker=b});
