...
var Bee=Bee||{};
(function(d,n,z,c){Bee.Dom=Bee.Dom||{};var r=d.getStyleValue,m=0,y=document.documentElement.style;Bee.Dom.Toolbox=function(a,b){d.assert(d.defined(window)&&d.defined(document),"Barge.Dom.Toolbox a window object as host");d.assert(d.defined(a.toolBoxID)||d.defined(a.toolBoxListNodeID)||d.defined(a.toolBoxItemsClassName),"Barge.Dom.Toolbox expects non-null params: toolBoxNodeID, toolBoxListNodeID, toolBoxItemsClassName");this.options={toolBoxID:"toolBox",toolBoxListNodeID:"toolBoxList",toolBoxItemsClassName:"toolBoxItem",
...
a.getAttribute("data-window"))};Bee.Dom.Toolbox.prototype._closeAllFlyOuts=function(a){if(this.toolBoxItems)for(this.i=0,this.len=a.length;this.i<this.len;this.i++){var b=a[this.i].children[1];a[this.i].children[1]&&"UL"===b.tagName&&c.closeWin(b)}};Bee.Dom.Toolbox.prototype._haveFlyOutOpen=function(a){return(a=a.children[1])&&"UL"===a.tagName&&"block"===a.style.display};Bee.Dom.Toolbox.prototype._resetToolBoxSize=function(a,b){d.defined(b.floatingWidth)&&d.css(a,{width:b.floatingWidth+10+"px"});
d.defined(b.floatingHeight)&&d.css(a,{height:b.floatingHeight+7+"px"})};Bee.Dom.Toolbox.prototype._getDisplayState=function(a){return"none"===a.style.display||""===a.style.display?0:1};Bee.Dom.Toolbox.prototype._openWin=function(a){0===d.getDisplayState(a)&&c.setDisplayState(a,"block")};Bee.Dom.Toolbox.prototype._insertCustomToolTip=function(a){var b=this;d.forEach(b.toolBoxItems,function(a){a.children[0]&&(a.children[0].title="")});if(!a){b.toolTip=c.createEl("div",{id:"toolTip"},{top:0,left:0,display:"none"});
c.appendToWindow(b.toolTip);var f;a=d.getElementsByAttribute("data-tbTip");this.Be.bindOnAll(a,"mouseover",function(a){if(!1===b.aFlyOutIsOpen){a=this.parentElement;var e=c.getRight(a)/2-6,g=(!c.getEl("#propertyBar")||c.getEl("#propertyBar")&&!b.docked?6:46)+(0===d.pInt(b.toolTipProps.topOffset)||b.docked?30:d.pInt(b.toolTipProps.topOffset));c.alignLeft(a,b.toolTip,b.toolTipProps.leftOffset);c.anchorBottom(a,b.toolTip,g);c.setPseudoStyle(b.toolTip,"before","left",e+"px");a=this.getAttribute("data-tbTip").split(",");
var k=!n.isEmpty(a[0]);b.toolTip.innerHTML=a[0];f=setTimeout(function(){clearTimeout(f);k&&(d.openWin(b.toolTip),b.toolTipIsShowing=!0)},300)}},!1);this.Be.bindOnAll(a,"mouseout",function(a){0===b._getDisplayState(b.toolTip)?clearTimeout(f):f=setTimeout(function(){clearTimeout(f);d.closeWin(b.toolTip);b.toolTipIsShowing=!1},100)})}};Bee.Dom.Toolbox.prototype.addClickEvent=function(){var a=this;this.Be.bindOnAll(a.toolBoxItems,"click",function(b){var f=this.children[1]?this.children[1]:null,e=this.children[0];
...
f||b.parentNode!==this)c.css(e,{backgroundColor:""}),toolBoxFlyOutIsOpen=a.aFlyOutIsOpen=!1})};Bee.Dom.Toolbox.prototype.addMouseOutEvent=function(){var a=this;this.Be.bindOnAll(this.toolBoxItems,"mouseout",function(){a.openFlyOut&&c.css(this.children[0],{backgroundColor:""})})};Bee.Dom.Toolbox.prototype.addMouseOverEvent=function(){var a=this;this.Be.bindOnAll(this.toolBoxItems,"mouseover",function(b){if(a.aFlyOutIsOpen){b=this.children[1];var f=this.children[0];this.children[1]&&"UL"===b.tagName?
...
Bee.Dom.Toolbox.prototype.addCloseOutEventOnBodyClick=function(){var a=this;this.Be.bind(window,"mouseup",function(b){var d=b.target.tagName?"body"===b.target.tagName.toLowerCase()||"html"===b.target.tagName.toLowerCase():null;a.aFlyOutIsOpen&&(b.target.parentNode.classList&&!b.target.parentNode.classList.contains("toolBoxItem")?(c.closeWin(a.openFlyOut),a.aFlyOutIsOpen=!1):d&&(c.closeWin(a.openFlyOut),a.aFlyOutIsOpen=!1))})};Bee.Dom.Toolbox.prototype.createThumb=function(){this.thumbGrip=d.createEl("div",
{className:"hDockThumb"});!0===this.options.expandable&&(this.expandBtn=d.createEl("div",{className:"expandBtn fa fa-angle-double-right"},{position:"relative",float:"right",height:"100%",width:"10px",fontSize:"8px",textAlign:"right",lineHeight:"6px",fontWeight:"600"}),this.dynamicStyleSheet.innerHTML+=".expandBtn:hover{ color:#fff;}",this.thumbGrip.appendChild(this.expandBtn));c.insertChildAt(this.toolBox,this.thumbGrip,0)};Bee.Dom.Toolbox.prototype.addClassNameToList=function(){this.toolBoxItems=
d.nodeListToArray(this.list.children);var a=this;d.forEach(this.toolBoxItems,function(b){c.addClass(b,a.options.toolBoxItemsClassName)})};Bee.Dom.Toolbox.prototype.dock=function(){d.css(this.toolBox,{top:0,left:0});this.docked=!0;!0===this.options.keepState&&!0===this.options.keepPosition&&localStorage.setItem("toolBoxDockState","true")};Bee.Dom.Toolbox.prototype.makeUnDockable=function(){var a=this;c.css(a.toolBox,{width:a.toolBox.offsetWidth,height:a.toolBox.offsetHeight,border:"1px solid var(--dividerColor)",
...
localStorage.setItem("toolBoxDockState","false"),31>r("top",e.toBeMoved)&&(e.toBeMoved.style.top="31px"),d.defined(a.options.elOnRight)&&Bee.Dom.CSSSTYLE.setProperty("--toolBoxWith","0px"));if(!0===a.options.keepState&&!0===a.options.keepPosition&&!0===a.options.unDockable){f=c.getLeft(e.toBeMoved).toString();var k=c.getTop(e.toBeMoved).toString();localStorage.setItem("toolBoxXY",f+","+k)}document.removeEventListener("mousemove",w,!1);document.removeEventListener("mouseup",x,!1)},w=function(g){if(f.tolerance){c.css(b,
...
g.clientY&&!a.docked&&(e.toBeMoved.style.top=v+g.clientY-u+"px")},q=p.clientX,u=p.clientY;document.addEventListener("mouseup",x,!1);document.addEventListener("mousemove",w,!1)}},!1)}(a.thumbGrip,{prevDef:!1,moveParent:!0,tolerance:30,floatingHeight:a.list.offsetHeight+a.thumbGrip.offsetHeight})};Bee.Dom.Toolbox.prototype.makeStateful=function(){var a=this;if(!0===this.options.unDockable&&!0===this.options.keepPosition){var b=localStorage.getItem("toolBoxXY").split(","),c=localStorage.getItem("toolBoxDockState");
