 ...
 *    @requires{@link Barge.String, @link Barge.Keyboard}
 *    @requires{@link Barge.Event, @link Barge.Keyboard.KeyCodes}
 *
 *    @version 3.15
 */
...
(function (Bu, Ba, Bs, Bd, Bk)
{
   ...
   Barge.Input.Checkbox.prototype.restrictChecks = function (className, maxChecks)
   {
      ...
      let rChbXs = Bu.defined(className) ?
                   !Bu.isString(className) && Bu.isArrayLike(className) ? className : document.getElementsByClassName(className) :
