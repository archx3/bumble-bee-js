...
localStorage.setItem("toolBoxDockState","false"),31>gsv("top",a.toBeMoved)&&(a.toBeMoved.style.top="31px"),d.defined(b.options.elOnRight)&&Bee.Dom.CSSSTYLE.setProperty("--toolBoxWith","0px"));if(!0===b.options.keepState&&!0===b.options.keepPosition&&!0===b.options.unDockable){g=c.getLeft(a.toBeMoved).toString();var e=c.getTop(a.toBeMoved).toString();localStorage.setItem("toolBoxXY",g+","+e)}document.removeEventListener("mousemove",m,!1);document.removeEventListener("mouseup",p,!1)}h=void 0===h?{}:
