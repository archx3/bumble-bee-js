var Bee=Bee||{};
(function(r,h){"function"===typeof define&&define.amd?define([],function(){return r.tSorter=h(r)}):"object"===typeof exports?module.exports=h(r):r.tSorter=h(r)})(window,function(r){function h(a,c){this.tableEl=a;this.hasInputs=this.DATE_RE=null;this.options={rowStepping:1,DATE_RE:null};l.defined(c)&&(this.options=l.extend(this.options,c))}var l=Bee.utils,D=Bee.Array,n=Bee.Dom,J=new Bee.Event.EventManager,z=null,p=null,E=null,e=null,F=null,G=null,A=null,H=null,w=null,k=null,I=null,B=null,C=null,q=
null,x,t,y,m,u,v,b,d;h.prototype.init=function(){var a=this;l.assert(document.createElement||document.getElementsByTagName,"TableSorter requires document.createElement and document.getElementsByTagName");this.DATE_RE=/^(\d\d?)[\/\.-](\d\d?)[\/\.-]((\d\d)?\d\d)$/;l.defined(this.tableEl)?(n.addClass(this.tableEl,"sortable"),a.makeSortable(this.tableEl)):D.forEach(document.getElementsByTagName("table"),function(c){n.classListContains(c,"sortable")&&(console.log(a),a.makeSortable(c))})};h.prototype.makeSortable=
...
e;g>b;--g)0>c(a[g],a[g-1])&&(d=a[g],a[g]=a[g-1],a[g-1]=d,d=!0);b++}};return Bee.Dom.TableSorter=h});
