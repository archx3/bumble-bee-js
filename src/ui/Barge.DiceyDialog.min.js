...
function(d){b.dismiss();if(c.defined(a.onCancel)&&c.isFunction(a.onCancel))a.onCancel(c.defined(b.inputEl)?b.inputEl.value:null);else c.defined(a.cancel)&&c.isFunction(a.cancel)&&a.cancel(c.defined(b.inputEl)?b.inputEl.value:null)});!0===a.dismissOnOverlayClick&&this.overlay.addEventListener("click",function(a){b.dismiss()})};e.prototype.makeDraggable=function(){new Barge.Drag.Movable(this.dialog)};e.prototype.dismiss=function(){d.closeWin(this.dialog,!0);d.closeWin(this.overlay,!0)};e.prototype.close=
e.prototype.dismiss;var k=new e({buttonAlignment:"right"});Barge.DiceyDialog={alert:function(a){k.alert(a)},confirm:function(a){k.confirm(a)},fileDialog:function(a){k.fileDialog(a)},progressDialog:function(a){k.progressDialog(a)},dismiss:function(){k.dismiss()}};return Barge.DiceyDialog});
