...
a)};c.prototype.canNavigate=function(a){return p.isBetweenInclusive(a,{min:0,max:this.pages.length})};c.prototype.showPage=function(a){this.closeRows(2);a=this.pages[a-1];f.forEach(a,function(a,c){e.css(a,{display:""})});a=null};return Barge.Dom.Table=c});
